...
if($page > $out): $x_f = $out; endif;
		if($page > 2){ echo"<li><a href=\"/\" title=\"на первую страницу\"><<</a></li>"; }
		if($page){ $prev_num = $page-1; $prev = "?page=".$prev_num; if($prev_num == 1): $prev = "/"; endif;
...
for ($x=$x_f; $x<$pages; $x++){
	...
	if($x == 1){
			echo"<li".$active."><a href=\"/\" title=\"1-ая страница\">".$x."</a></li>";
	}else{
