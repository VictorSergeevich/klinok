...
<div class="navigated">
    ...
    <ul class="breadcrumbs">
      ...
      <li><?=($arResult["TITLE"])?$arResult["TITLE"]:$arResult["NAME"];?></li>
    </ul>
</div>
	<div class="item" itemscope itemtype="http://schema.org/Recipe">
	<div class="zagolovok">
	...
	<div class="img">
		<?if(!empty($arResult["IMG"]) && file_exists($_SERVER["DOCUMENT_ROOT"] . $arResult["IMG"])):?>
			<img itemprop="image" src="<?=$arResult["IMG"];?>" alt="<?=$arResult["NAME"];?>" title="<?=$arResult["NAME"];?> фото №1">
		<?endif;?>
	</div>
	<?
...
<script src="/components/recept/templates/default/script.js"></script>